...
clearDrugVisualEffects = function()
    if Config.Debug then lib.print.info('Clearing Drug Visual Effects') end
    local ped = PlayerPedId()
...
RegisterNetEvent('BS-Breathalyzer:client:takeDrug', function(drugItem)
...
lib.callback.register('BS-Breathalyzer:client:isDrugOnCooldown', function(drugItem)
...
lib.callback.register('BS-Breathalyzer:client:getCurrentDrugEffect', function()
    return currentDrug
end)